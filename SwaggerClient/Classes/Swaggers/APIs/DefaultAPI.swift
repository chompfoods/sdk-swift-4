...
open class DefaultAPI {
  ...
  "items" : [ {
     ...
     */
    public enum Limit_foodBrandedNamePhpGet: Int { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
        case _4 = 4
    ...
    /**
     ...
     - parameter name: (query) #### Search for branded food items using a general food name keyword. This does not have to exactly match the \&quot;official\&quot; name for the food.  **Example** &gt; &#x60;&#x60;&#x60;&amp;name&#x3D;Starburst&#x60;&#x60;&#x60;       - parameter limit: (query) #### Set maximum number of records you want the API to return. The default value is \&quot;**10**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;limit&#x3D;10&#x60;&#x60;&#x60;  (optional)     - parameter page: (query) #### This is how you paginate the search result. By default, you will see the first 10 records. You must increment the page number to access the next 10 records, and so on. The default value is \&quot;**1**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;page&#x3D;1&#x60;&#x60;&#x60;  (optional)     - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func foodBrandedNamePhpGet(name: String, limit: Limit_foodBrandedNamePhpGet? = nil, page: Int? = nil, userId: String? = nil, completion: @escaping ((_ data: BrandedFoodObject?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
    ...
    "brand_list" : [ "brand_list", "brand_list" ]
     ...
     - returns: RequestBuilder<BrandedFoodObject> 
     */
    open class func foodBrandedNamePhpGetWithRequestBuilder(name: String, limit: Limit_foodBrandedNamePhpGet? = nil, page: Int? = nil, userId: String? = nil) -> RequestBuilder<BrandedFoodObject> {
     ...
     * enum for parameter limit
     */
    public enum Limit_foodBrandedSearchPhpGet: Int { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
        case _4 = 4
    ...
    /**
     ...
     - parameter allergen: (query) #### Filter the search to only include branded foods that contain a specific allergen.  **Example** &gt; &#x60;&#x60;&#x60;&amp;allergen&#x3D;Peanuts&#x60;&#x60;&#x60;  **Important Note**: This parameter cannot be used alone. It must be paired with at least 1 additional parameter.  (optional)     - parameter brand: (query) #### Filter the search to only include branded foods that are owned by a specific brand.  **Example** &gt; &#x60;&#x60;&#x60;&amp;brand&#x3D;Starbucks&#x60;&#x60;&#x60;  (optional)     - parameter category: (query) #### Filter the search to only include branded foods from a specific category.  **Example** &gt; &#x60;&#x60;&#x60;&amp;category&#x3D;Plant Based Foods&#x60;&#x60;&#x60;  (optional)     - parameter country: (query) #### Filter the search to only include branded foods that are sold in a specific country.  **Example** &gt; &#x60;&#x60;&#x60;&amp;country&#x3D;United States&#x60;&#x60;&#x60;  **Important Note**: This parameter cannot be used alone. It must be paired with at least 1 additional parameter.  (optional)     - parameter diet: (query) #### Filter the search to only include branded foods that are considered compatible with a specific diet.  **Important Note**: This parameter cannot be used alone. It must be paired with at least 1 additional parameter.  (optional)     - parameter ingredient: (query) #### Filter the search to only include branded foods that contain a specific ingredient.  **Example** &gt; &#x60;&#x60;&#x60;&amp;ingredient&#x3D;Salt&#x60;&#x60;&#x60;  (optional)     - parameter keyword: (query) #### Filter the search to only include branded foods that are associated with a specific keyword.  **Example** &gt; &#x60;&#x60;&#x60;&amp;keyword&#x3D;Organic&#x60;&#x60;&#x60;  **Important Note**: This parameter cannot be used alone. It must be paired with at least 1 additional parameter.  (optional)     - parameter mineral: (query) #### Filter the search to only include branded foods that contain a specific mineral.  **Example** &gt; &#x60;&#x60;&#x60;&amp;mineral&#x3D;Potassium&#x60;&#x60;&#x60;  (optional)     - parameter nutrient: (query) #### Filter the search to only include branded foods that contain a specific nutrient.  **Example** &gt; &#x60;&#x60;&#x60;&amp;nutrient&#x3D;Caffeine&#x60;&#x60;&#x60;  **Important Note**: This parameter cannot be used alone. It must be paired with at least 1 additional parameter.  (optional)     - parameter palmOil: (query) #### Filter the search to only include branded foods that contain a specific ingredient made using palm oil.  **Example** &gt; &#x60;&#x60;&#x60;&amp;palm_oil&#x3D;E160a Beta Carotene&#x60;&#x60;&#x60;  (optional)     - parameter trace: (query) ### Filter the search to only include branded foods that contain a specific trace ingredient.  **Example** &gt; &#x60;&#x60;&#x60;&amp;trace&#x3D;Tree Nuts&#x60;&#x60;&#x60;  **Important Note**: This parameter cannot be used alone. It must be paired with at least 1 additional parameter.  (optional)     - parameter vitamin: (query) #### Filter the search to only include branded foods that contain a specific vitamin.  **Example** &gt; &#x60;&#x60;&#x60;&amp;vitamin&#x3D;Biotin&#x60;&#x60;&#x60;  (optional)     - parameter limit: (query) #### Set maximum number of records you want the API to return. The default value is \&quot;**10**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;limit&#x3D;10&#x60;&#x60;&#x60;  (optional)     - parameter page: (query) #### This is how you paginate the search result. By default, you will see the first 10 records. You must increment the page number to access the next 10 records, and so on. The default value is \&quot;**1**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;page&#x3D;1&#x60;&#x60;&#x60;  (optional)     - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func foodBrandedSearchPhpGet(allergen: String? = nil, brand: String? = nil, category: String? = nil, country: String? = nil, diet: Diet_foodBrandedSearchPhpGet? = nil, ingredient: String? = nil, keyword: String? = nil, mineral: String? = nil, nutrient: String? = nil, palmOil: String? = nil, trace: String? = nil, vitamin: String? = nil, limit: Limit_foodBrandedSearchPhpGet? = nil, page: Int? = nil, userId: String? = nil, completion: @escaping ((_ data: BrandedFoodObject?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
    ...
    /**
     ...
     - parameter find: (query) Search our database for a single ingredient or a specific set of ingredients.  **Example #1: Single Ingredient** &gt; &#x60;&#x60;&#x60;&amp;find&#x3D;raw broccoli&#x60;&#x60;&#x60;  **Example #2: Set of Ingredients** &gt; &#x60;&#x60;&#x60;&amp;find&#x3D;raw broccoli,buttermilk waffle,mashed potatoes&#x60;&#x60;&#x60;  **Important Notes**    * Comma-separated lists cannot contain more than **10 ingredients**. You must perform additional API calls if you are looking up more than 10 ingredients.       - parameter limit: (query) #### Set maximum number of records you want the API to return, per search term. The default value is \&quot;**1**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;limit&#x3D;3&#x60;&#x60;&#x60;  (optional)     - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func foodIngredientSearchPhpGet(find: String, limit: Limit_foodIngredientSearchPhpGet? = nil, userId: String? = nil, completion: @escaping ((_ data: IngredientObject?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
    ...
    /**
     Get a recipe by ID
     - parameter _id: (query) #### A recipe ID. Recipe IDs are exposed in the /recipe/search and /recipe/ingredient endpoints.  **Example** &gt; &#x60;&#x60;&#x60;&amp;list&#x3D;tdm_1143_0459d0028fcf8990724785b9e6775037&#x60;&#x60;&#x60;       - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func recipeIdPhpGet(_id: String, userId: String? = nil, completion: @escaping ((_ data: RecipeObject?,_ error: Error?) -> Void)) {
        recipeIdPhpGetWithRequestBuilder(_id: _id, userId: userId).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "items" : [ {
     ...
     */
    open class func recipeIdPhpGetWithRequestBuilder(_id: String, userId: String? = nil) -> RequestBuilder<RecipeObject> {
     ...
     * enum for parameter limit
     */
    public enum Limit_recipeIngredientPhpGet: Int { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
    }
    ...
    /**
     ...
     - parameter list: (query) #### A single ingredient, or a comma-separated list of up to 3 ingredients. Recipes with each of these ingredients will be returned. **You can pass in up to 3 ingredients at a time.**  **Example** &gt; &#x60;&#x60;&#x60;&amp;list&#x3D;cheese,tomato,milk&#x60;&#x60;&#x60;       - parameter limit: (query) #### Set maximum number of records you want the API to return. The default value is \&quot;**3**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;limit&#x3D;3&#x60;&#x60;&#x60;  (optional)     - parameter page: (query) #### This is how you paginate the search result. By default, you will see the first 3 records. You must increment the page number to access the next 3 records, and so on. The default value is \&quot;**1**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;page&#x3D;1&#x60;&#x60;&#x60;  (optional)     - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func recipeIngredientPhpGet(list: String, limit: Limit_recipeIngredientPhpGet? = nil, page: Int? = nil, userId: String? = nil, completion: @escaping ((_ data: RecipeObject?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
    ...
    "nutrients" : {
     ...
     - returns: RequestBuilder<RecipeObject> 
     */
    open class func recipeIngredientPhpGetWithRequestBuilder(list: String, limit: Limit_recipeIngredientPhpGet? = nil, page: Int? = nil, userId: String? = nil) -> RequestBuilder<RecipeObject> {
     ...
     * enum for parameter limit
     */
    public enum Limit_recipeRandomPhpGet: Int { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
        case _4 = 4
    ...
    /**
     ...
     - parameter limit: (query) #### Set maximum number of records you want the API to return. The default value is \&quot;**5**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;limit&#x3D;5&#x60;&#x60;&#x60;  (optional)     - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func recipeRandomPhpGet(limit: Limit_recipeRandomPhpGet? = nil, userId: String? = nil, completion: @escaping ((_ data: RecipeObject?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
     ...
     */
    public enum NutrientsRequired_recipeSearchPhpGet: Int { 
        case _1 = 1
        case _0 = 0
    }
     ...
     * enum for parameter limit
     */
    public enum Limit_recipeSearchPhpGet: Int { 
        case _1 = 1
        case _2 = 2
        case _3 = 3
        case _4 = 4
    ...
    /**
     ...
     - parameter title: (query) #### A recipe title  **Example** &gt; &#x60;&#x60;&#x60;&amp;title&#x3D;Banana Bread&#x60;&#x60;&#x60;       - parameter excludedCuisine: (query) #### A specific cuisine you want excluded from results  **Example** &gt; &#x60;&#x60;&#x60;&amp;excluded_cuisine&#x3D;Italian&#x60;&#x60;&#x60;  (optional)     - parameter includedCuisine: (query) #### A specific cuisine you want included in results  **Example** &gt; &#x60;&#x60;&#x60;&amp;included_cuisine&#x3D;Chinese&#x60;&#x60;&#x60;  (optional)     - parameter excludedIngredient: (query) #### Recipes with this ingredient will be excluded from results  **Example** &gt; &#x60;&#x60;&#x60;&amp;excluded_ingredient&#x3D;egg&#x60;&#x60;&#x60;  (optional)     - parameter includedIngredient: (query) #### Only recipes with this ingredient will be returned  **Example** &gt; &#x60;&#x60;&#x60;&amp;included_ingredient&#x3D;apple&#x60;&#x60;&#x60;  (optional)     - parameter nutrientsRequired: (query) #### Optionally require all recipes to include nutrition info. Recipes with, or without, nutrition info are returned by default.  **Example** &gt; &#x60;&#x60;&#x60;&amp;nutrients_required&#x3D;1&#x60;&#x60;&#x60;  (optional)     - parameter limit: (query) #### Set maximum number of records you want the API to return. The default value is \&quot;**5**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;limit&#x3D;3&#x60;&#x60;&#x60;  (optional)     - parameter page: (query) #### This is how you paginate the search result. By default, you will see the first 5 records. You must increment the page number to access the next 5 records, and so on. The default value is \&quot;**1**.\&quot;  **Example** &gt; &#x60;&#x60;&#x60;&amp;page&#x3D;1&#x60;&#x60;&#x60;  (optional)     - parameter userId: (query) #### **Only required for Premium subscribers.** The unique identifier assigned to each user on your platform. This can be any string of letters or numbers and doesn&#x27;t have to relate to your own database. [Learn more](https://desk.zoho.com/portal/chompthis/en/kb/articles/monthly-active-users)  **Example** &gt; &#x60;&#x60;&#x60;&amp;user_id&#x3D;fehef8w4ha&#x60;&#x60;&#x60;  (optional)
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func recipeSearchPhpGet(title: String, excludedCuisine: String? = nil, includedCuisine: String? = nil, excludedIngredient: String? = nil, includedIngredient: String? = nil, nutrientsRequired: NutrientsRequired_recipeSearchPhpGet? = nil, limit: Limit_recipeSearchPhpGet? = nil, page: Int? = nil, userId: String? = nil, completion: @escaping ((_ data: RecipeObject?,_ error: Error?) -> Void)) {
  ...
  "items" : [ {
    ...
    "nutrients" : {
     ...
     - returns: RequestBuilder<RecipeObject> 
     */
    open class func recipeSearchPhpGetWithRequestBuilder(title: String, excludedCuisine: String? = nil, includedCuisine: String? = nil, excludedIngredient: String? = nil, includedIngredient: String? = nil, nutrientsRequired: NutrientsRequired_recipeSearchPhpGet? = nil, limit: Limit_recipeSearchPhpGet? = nil, page: Int? = nil, userId: String? = nil) -> RequestBuilder<RecipeObject> {
