...
public struct BrandedFoodObjectPortions: Codable {
    ...
    public init(measurementUnit: String? = nil, _description: String? = nil, modifier: String? = nil, gramWeight: BigDecimal? = nil, dataPoints: Int? = nil, footnote: String? = nil) { 
